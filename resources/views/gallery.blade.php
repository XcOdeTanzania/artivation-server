    ...
    <div class="row ml-2">
        <div class="dropdown m-1">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item text-capitalize" href="/gallery/0/{{$activeArtist['id']}}">All Categories</a>
            ...
            <div class="card ">
                ...
                <div class="card-footer bg-transparent border-success ">
                    <div class="row ">
                        ...
                        <a id="likePiece{{$piece['id']}}" onclick="likeItem(this,{{$piece['id']}},{{Auth::user()['id']}});" >
                            <i class="fa @if($piece['like_status']) echo fa-heart
                                          @else echo fa-heart-o @endif
                                    m-1" style="color: red"></i>
                        </a>

                        <small class="p-1">{{$piece['like_counts']}} likes </small>
                        <a id="cartPiece{{$piece['id']}}" onclick="addToCart(this,{{$piece['id']}});" class="btn btn-outline-success  ml-auto">
